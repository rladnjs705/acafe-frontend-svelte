<script>
  ...
  import notyf from '../../utils/notyfConfig';
      ...
      <ul class="order-inner-list">
        <li class="d-flex justify-content-between date">
          ...
          <p class="btnOrderCheck" >확인</p>
            ...
            <li class="d-flex justify-content-between ">
              <p class="orderChecked">아이템이름</p>
              <p class="orderChecked">0개</p>
            </li>   
            <li class="d-flex justify-content-between ">
              <p class="orderChecked">가격(개당: 1000)</p>
              <p class="orderChecked">1000</p>
            </li>                  
        <li class="d-flex justify-content-between total ">
          <p class="orderChecked">개수합계</p>
          <p class="orderChecked">0</p>
        </li>                   
        <li class="d-flex justify-content-between total ">
          <p class="orderChecked">가격합계</p>
          <p class="orderChecked">1000</p>
        </li>                                 
      </ul>
    </div>
